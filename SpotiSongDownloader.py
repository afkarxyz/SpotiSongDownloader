...
class UpdateDialog(QDialog):
    def __init__(self, current_version, new_version, parent=None):
        ...
        message = QLabel(f"SpotiSongDownloader v{new_version} Available!")
...
class SpotiSongDownloaderGUI(QWidget):
    ...
    def setup_settings_tab(self):
        ...
        cookies_layout.setSpacing(2)
        cookies_layout.setContentsMargins(0, 0, 0, 0)
        
        cookies_label = QLabel('Cookies')
        cookies_label.setStyleSheet("font-weight: bold; margin-top: 8px; margin-bottom: 5px;")
        cookies_layout.addWidget(cookies_label)
        
        self.cookies_input = QLineEdit()
        self.cookies_input.setPlaceholderText("Enter Cookies")
    ...
    def setup_about_tab(self):
        ...
        sections = [
            ("Check for Updates", "Check", "https://github.com/afkarxyz/SpotiSongDownloader/releases"),
            ("Report an Issue", "Report", "https://github.com/afkarxyz/SpotiSongDownloader/issues"),
            ("SpotiSongDownloader Site", "Visit", "spotisongdownloader.to")
        ]
...
if __name__ == '__main__':
    ...
    settings = QSettings('SpotiSongDownloader', 'Settings')
